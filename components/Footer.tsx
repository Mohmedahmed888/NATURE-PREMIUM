        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <div className="flex gap-4">
              ...
              <a href="#" aria-label="Instagram" className="p-2 rounded-lg bg-slate-800 hover:bg-slate-700 transition-colors">
            ...
            <p className="mt-4 text-sm text-slate-500">Contact: info@naturalpremium.com</p>
          </div>
        </div>
