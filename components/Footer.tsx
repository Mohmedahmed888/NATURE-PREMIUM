        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a href="#" aria-label="Facebook" className="p-2 rounded-lg bg-slate-800 hover:bg-slate-700 transition-colors">
              ...
              <a href="#" aria-label="WhatsApp" className="p-2 rounded-lg bg-slate-800 hover:bg-slate-700 transition-colors">
