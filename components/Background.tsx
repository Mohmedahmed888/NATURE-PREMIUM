export function Background() {
  return (
    <div className="fixed inset-0 -z-10 w-full">
      <div className="absolute inset-0 bg-gradient-to-b from-stone-100/80 via-amber-50/30 to-stone-50 dark:from-slate-900 dark:via-slate-900/95 dark:to-slate-900" />
