            ...
            <div className="flex flex-col lg:flex-row items-center gap-16">
              <div className="flex-1 order-2 lg:order-1">
                <div className="w-full h-72 lg:h-96 rounded-3xl overflow-hidden bg-gradient-to-br from-orange-100 to-brand-100 relative">
                  <div className="absolute inset-0 flex items-center justify-center">
                    ...
                    <div className="absolute bottom-8 left-8 w-24 h-24 bg-white/60 rounded-full" />
                  </div>
                </div>
              </div>
              <div className="flex-1 order-1 lg:order-2">
                ...
                <p className="mt-4 text-slate-600 text-lg leading-relaxed">
                  From natural oils to aloe gel and lavender soap, we offer a diverse range
                  that combines nature with luxury.
                </p>
              </div>
            </div>
          </div>
